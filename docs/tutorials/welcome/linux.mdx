...
## Method 1, old versions (easy way, directly in the bat)
...
## Method 2, old versions (complicated way, SteamTinkerLaunch)
...
* Under Compatibility force a specific compatibility tool select a Proton version (I used GE-Proton9-11)
* Launch the bat-Steam-game
* Wait for the game and LiveSplit to start
* Verify that SST works (check for the console output or see if sst commands can be autocompleted)
