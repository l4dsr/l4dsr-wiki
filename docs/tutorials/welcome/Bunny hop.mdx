...
## Basic of bunnyhopping
* . If [SST](https://mikes.software/sst) is installed, it can also be done from the main menu (other demo recording differences related to SST are listed [below](#sst)).
