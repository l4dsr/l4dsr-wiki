...
- Fork the [Wiki's GitHub repository](https://github.com/l4dsr/l4dsr-wiki)
...
Once you've hit that green button then badabing badaboom, you just forked the L4DSR Wiki, and you're ready to make some changes!

## Making your changes

I'm gonna show you a little magic trick. Click on the URL bar at the top of your browser. The URL should look something like `https://github.com/<yourname>/l4dsr-wiki` Now, change the `.com` to `.dev`

![](img/githubdotcom.jpg) ![](img/githubdotdev.jpg)
...
Once you've done that, you can double check that it actually went through by going to `github.com/<yourname>/l4dsr-wiki/commits/main`, which will show you a history of every commit ever made to the repository, including the ones that were made on the main repository before you created your fork.
...
:::caution todo
explain how to work in branches (should probably put this under the making your changes section idk)
:::
