...
- Click [HERE](https://github.com/ImAciidz/L4D-Speedrunning/wiki/Demos) for a guide on recording demos.
- **ALL PC RUNS must have demo proof in addition to video proof.**
- As of 7/17/23, **demo recording must contain the entirety of the intro cutscene** on the first level of the run.
